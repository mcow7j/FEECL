...
from FEECL import wedge,d,hodgestar,inner,volform,trialfunction,simplify,pullback
...
def test_simplifiy():
    ...
    assert not isinstance(w2.integrand,Pullback) and isinstance(w.integrand,Pullback) and not isinstance(w3,Pullback) and isinstance(w1,Pullback)
